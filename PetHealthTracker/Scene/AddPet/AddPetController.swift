...
final class AddPetController: BaseController {
    ...
    override func configureUI() {
        ...
        [backButton, headerLabel,
         ...
         neuteredCard, errorLabel, saveButton].forEach { contentView.addSubview($0) }
    ...
    override func configureConstraints() {
        NSLayoutConstraint.activate([
            ...
            petImageView.widthAnchor.constraint(equalToConstant: 42),
            petImageView.heightAnchor.constraint(equalToConstant: 42),
    ...
    @objc private func saveTapped() {
        ...
        guard let breed = selectedBreed ?? breedTextField.text,
              !breed.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty else {
        ...
        let request = CreatePetRequest(
            ...
            breed: breed,
            dob: isoFormatter.string(from: datePicker.date)
        )
        ...
        Task {
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    self.showError("Failed to create pet")
                }
            }
        }
    }
